...
description: >
  ...
  JetBrains Mono taxonomy, Anton body, the four-accent palette. Composition,
...
typography:
  ...
  body-lg:    { fontFamily: "Anton", px: 28, cqw: 1.46, weight: 400, lineHeight: 1.4 }
  body-md:    { fontFamily: "Anton", px: 24, cqw: 1.25, weight: 400, lineHeight: 1.3 }
...
- **Fonts** — already set to **Anton** (display) / **Anton** (body); ignore any preset font name lingering in prose.
...
counter, and axis as a "technical artifact" register. **Anton** carries the few body lines.
